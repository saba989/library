...
private RestTemplate restTemplate = new RestTemplate();
    ...
    final String URI_Users = "http://localhost:8081/librarymanagement/v1/addbook/";
	...
	System.out.println(booksentity);
		...
		try{
			...
			ResponseEntity<BooksEntity> book = restTemplate.exchange(URI_Users+booksentity.getBookCode(), HttpMethod.POST, requestUpdate,
			BooksEntity.class);
